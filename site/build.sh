...
cat > "$PUB/mobile.html" <<'MOBILE'
<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="robots" content="noindex"><title>Alo mobile preview</title>
<style>body{margin:0;background:#edf2e9;color:#20352d;font:13px system-ui}header{height:60px;display:flex;align-items:center;justify-content:center;gap:24px}a{color:inherit}iframe{display:block;border:1px solid #dfe6dd;border-radius:12px;width:390px;max-width:100%;height:844px;margin:0 auto;background:#fff;box-sizing:border-box}</style>
<header><strong>alo. · Mobile preview</strong><a href="/demo.html">Open full demo ↗</a></header><iframe src="/demo.html#clarity" title="Alo dashboard in a 390-pixel mobile viewport"></iframe></html>
MOBILE
...
<meta property="og:image" content="https://alo.asif.dev/img/dashboard.jpg">
...
<meta name="twitter:image" content="https://alo.asif.dev/img/dashboard.jpg">
<style>
